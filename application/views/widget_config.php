  ...
  <div class="form-container">
    ...
    <form id="widget_config_form">
      ...
      <?php
		...
		if($widgetName=='slideup'):
			print '<li class="form-label" >Widget Title</li>';
		else:
			print '<li class="form-label" >Backgroud Colour</li>';
		endif;
	  ?>
		...
		if($widgetName=='slideup'):
			?>
			 <li class="form-label">Widget Alignment</li>
			  <li>
				<select  name="widgetTitle" id="widgetTitle">
					<?php
					if(isset($widget_instance_details['CustomTitle']) && $widget_instance_details['CustomTitle']!=''){
						if($widget_instance_details['CustomTitle']=='one'){
							print '<option value="one" selected>one</option>';
							print '<option value="two">two</option>';
							print '<option value="rightpanel">rightpanel</option>';
						}else if($widget_instance_details['CustomTitle']=='two'){
							print '<option value="one" >one</option>';
							print '<option value="two" selected>two</option>';
							print '<option value="rightpanel">rightpanel</option>';
						}else if($widget_instance_details['CustomTitle']=='rightpanel'){
							print '<option value="one" >one</option>';
							print '<option value="two">two</option>';
							print '<option value="rightpanel" selected>rightpanel</option>';
						}
...
function define_section_content_type($section_name, $content_type_list)
{
  ...
  $english_section_name_list 	= array("Gallery"=>'Photos', "Video"=>'Video', "Audio"=>'Audios', "Resources"=>'Resources');			  
