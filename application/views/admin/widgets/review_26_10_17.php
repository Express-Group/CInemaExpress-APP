...
<div class="row">
	<fieldset class="FieldTopic">
        <legend class="topic"><?php print $widget_custom_title ?></legend>
     </fieldset>
	 <?php
	 if(count($widget_contents)>0){
		...
		foreach($widget_contents as $get_content){
			...
			if($GetRating!=0){
				if($n==1){
					?>
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 review-widget review-first-col">
						<div class="review-image">
							<img src="<?php print  $show_image ?>" class="img-responsive" alt="<?php print $imagealt ?>" title=" <?php print $imagetitle ?>">
						</div>
						<div class="review-rating">
							...
							<div class="review-title">
								<a href="<?php print $live_article_url ?>"><?php print $display_title ?></a>
							</div>	
							</div>
						</div>
					</div>
					...
					?>
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 review-widget">
						<div class="review-image">
							<img src="<?php print  $show_image ?>" class="img-responsive" alt="<?php print $imagealt ?>" title=" <?php print $imagetitle ?>">
						</div>
						<div class="review-rating">
	 ...
	 ?>
	<div class="col-md-12 review-more">
	<a href="<?php print $widget_section_url; ?>">More >></a>
	</div>
</div>