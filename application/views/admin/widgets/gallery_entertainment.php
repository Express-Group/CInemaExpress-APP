...
$show_simple_tab    .='<div class="row">
                       ...
                       <div class="GallerySection" '.$widget_bg_color.'>
...
$show_simple_tab .='<a style="color:#ed1c24;" class="pull-right" href="'.$widget_section_url.'">More Photos <i class="fa fa-chevron-right"></i></a>';
}
$show_simple_tab .='</div>
</div>
</div>';
