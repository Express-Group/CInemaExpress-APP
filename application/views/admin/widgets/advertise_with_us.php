<div class="row">
        ...
        <h4 class="statich4">Group Websites:</h4>
         ...
         <li><a href="#"><i class="fa fa-angle-right"></i> SAMAKALIKA MALAYALAM</a></li>
		 <li><a href="#"><i class="fa fa-angle-right"></i> EDEX LIVE</a></li>
		 <li><a href="#"><i class="fa fa-angle-right"></i> INDULGEXPRESS</a></li>
         ...
         <h4 class="statich4">For advertising in our newspapers:</h4>
          ...
          <li>VASUDEVAN</li>
          <li>9894304081</li>
          <li><a href="#">vasudevan.s@newindianexpress.com</a></li>
          </ul>
          </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <li>VENKATESWARAN</li>
          <li>9842441941</li>
          <li><a href="#">venkateswaran@newindianexpress.com</a></li>
          </ul>
          </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <li>PRADESH</li>
          <li>9943975515</li>
          <li><a href="#">pradesh.b@newindianexpres.com</a></li>
          </ul>
          </div>
		  <div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">NAGAPATTINAM</li>
          <li>KARTHIK</li>
          <li>9500032192</li>
          <li><a href="#">karthickg@newindianexpress.com</a></li>
          </ul>
          </div>
         <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">BELAGAVI</li>
          <li>DHANANJAY</li>
          <li>9538884222</li>
           <li><a href="#">dhananjay@newindianexpress.com</a></li>
          </ul>
          </div>
           <div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">SHIVAMOGGA</li>
          <li>KARTHIK</li>
          <li>9844549436</li>
         <li><a href="#">kardhikdk@newindianexpress.com</a></li>
         </ul>
         </div>
           <div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">MANGALURU</li>
          <li>DHANURAJ</li>
          <li>9244351389</li>
         ...
         <!--<div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">HUBBALLI</li>
          <li>SATISH JOSHI</li>
          <li>9483490965</li>
          ...
          <li>RAVI KAKADE</li>
          <li>9243242069</li>
          <li><a href="#">ravikakade@newindianexpress.com</a></li>
          </ul>
          </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <li>BINOY DANIEL</li>
          <li>9847880844</li>
          <li><a href="#">binoydaniel.p@newindianexpress.com</a></li>
          </ul>
          </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <li>PADMAKUMAR</li>
          <li>94472 20913</li>
           <li><a href="#">spadmakumar@newindianexpress.com</a></li>
            </ul>			
            </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
		  <li class="static-bold">KOZHIKODE</li>
          <li>SEBASTIAN P. JOHN</li>
          <li>9961149718</li>
           <li><a href="#">sebastian@newindianexpress.com</a></li>         
          </ul>
          </div>
          <div class="Advertise-sec">
          <ul class="table-cover">
         ...
         <div class="Advertise-sec">
          ...
          <li>MEHARBABA</li>
          <li>9246391064</li>
           <li><a href="#">psmeharbaba@newindianexpress.com</a></li>
          </ul>
          </div>
         <div class="Advertise-sec">
          <ul class="table-cover">
        ...
        <div class="Advertise-sec">
          ...
          <li>NATARAJAN</li>
          <li>9821042372</li>
           <li><a href="#">natarajan.v@newindianexpress.com</a></li>
      </ul>
      </div>
         <div class="Advertise-sec">
          <ul class="table-cover">
          ...
          <li>LEENA JHALANI</li>
          <li>9811270571</li>
           <li><a href="#">leena@newindianexpress.com</a></li>
         </ul>
         </div>
		   <div class="Advertise-sec">
          <ul class="table-cover">
          <li class="static-bold">KOLKATA</li>
          <li>NEHA PERIWAL</li>
          <li>9831005667</li>
           <li><a href="#">neha@newindianexpress.com</a></li>
          </ul>
          </div>
        
             <h4 class="statich4 pull-left margin-top-10">For online advertising, Please contact</h4> 
             <div class="Advertise-sec">
				  <ul class="table-cover">
				  <li class="static-bold">MUMBAI</li>
			...
			<div id="no-more-tables" style="padding-top: 2rem;">
