...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 <?php if($is_home=='n'){ echo 'poll-home';}?>">
	<h5 class="block-title margin-bottom-10"><span><a>Poll</a></span></h5>
    <div class="polls">
      <?php
      ...
      <div class="BeforePoll">
        <div class="polls_img">
          <?php if($show_image!="") { ?>
          <img src="<?php echo $dummy_image; ?>" data-src="<?php echo $show_image; ?>" title="<?php echo $imagetitle; ?>" alt="<?php echo $imagealt; ?>" />
          <?php } ?>
