<style>a[data-type="twitter"] .csbuttons-count { visibility:hidden; }</style>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
    ...
    <?php  if($author_image!=''){?> 
   <div class="author_img"><img class="img-circle" alt="" src="<?php echo BASEURL.$author_image;?>"></div> 
  ...
  <?php if($is_author==1 && $is_agency==1){ ?>
   ...
   <?php if($author_name!=''):  ?>
   &nbsp; | &nbsp;  <span class="publish_span">Published: <?php echo $published_date;?></span></p>
   <?php else: ?>
	 &nbsp;  <span class="author_name">Published: <?php echo $published_date;?></span></p></div>
	 <?php endif; ?>
  </div>
</div>
<?php
