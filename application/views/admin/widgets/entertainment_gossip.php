...
{
$show_simple_tab.=	' <h5 class="block-title margin-bottom-10"><span><a href="'.$widget_section_url.'">'.$widget_custom_title.'</a></span></h5>';
}
else
{
$show_simple_tab.=	'<h5 class="block-title margin-bottom-10"><span><a>'.$widget_custom_title.'</a></span></h5>';
}
...
if(count($widget_contents)>0)
{
	...
	if(strtolower($section_name)=='videos'){
		$show_simple_tab.= '<img src="'.image_url.'uploads/user/imagelibrary/video-icon.png" class="GalleryIcon" style="position:absolute;">'; 
	}
	$show_simple_tab.= '</div>';
	$count ++;	
...
if($widget_section_url!=''){
	$show_simple_tab .= '<a style="color:#ed1c24;" class="pull-right" href="'.$widget_section_url.'">More '.$widget_custom_title.' <i class="fa fa-chevron-right"></i></a>';
	}
