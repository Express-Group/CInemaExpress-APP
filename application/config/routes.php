...
$route[folder_name.'/(:any)'] = "user/section_controller";
$route[folder_name.'/clog'] = "user/section_controller";
...
$route[folder_name.'/byline'] 	= folder_name."/author_manager/byline";
...
$route['articles/(:num)/(:num)/section.json'] = "user/readwhere_controller/sectionwise/$1/$2";
