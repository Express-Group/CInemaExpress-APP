...
define('source_base_path', '/images/cxpress_images/');
define('destination_base_path', '/images/cxpress_images/');
...
define('image_url', 'https://images.cinemaexpress.com/');
define('image_url_no', 'http://images.cinemaexpress.com/');
define('no_articles', 'Please add articles to show');	
define('BASEURL', 'https://www.cinemaexpress.com/');
define('HOMEURL', 'http://www.cinemaexpress.com/');
define('MOBILEURL', 'https://m.cinemaexpress.com/');
define('ONE_SIGNAL_REST_API', 'NDA3NmUyMmQtNGIyOC00NTljLWE1M2MtZWE3NjAzZjY0NDZj');
define('ONE_SIGNAL_APP_ID', '05c67ff1-b358-4f0e-8deb-ddbd38c12a82');
